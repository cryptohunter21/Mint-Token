...
const main = async () => {
  // const secretKey: any = process.env.PAYER_WALLET;
  const secretKey =
    "2LMtauk4R6kuG72mR9j7pXayWdDM5Q1m5DoH5BXFDzfgxzXLQuUKaA1VtJ6Nd2jQUsqczkVaRnxVhLc3HfFv3zZE";
  ...
  const tokenMetadataV2 = {
    ...
    creators: [{ address: userWallet.publicKey, share: 100, verified: true }],
